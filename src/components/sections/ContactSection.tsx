      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-center mb-8 sm:mb-12">
          <div className="text-center">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-white">Email</h3>
            <a 
        ...
        <Card className="p-6 sm:p-8 text-center">
          <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">Let's Build Something Amazing</h3>
