  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden px-4 sm:px-6">
      ...
      <div className="container-custom text-center relative z-10 py-20 sm:py-0">
        ...
        <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl mb-6 sm:mb-8 text-gray-300 px-2">
          Technology Solutions & Consulting
        </h2>
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 text-gray-400 max-w-4xl mx-auto px-4">
          Delivering modern web development with thoughtful engineering
        </p>
        <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4 mb-8 sm:mb-12 text-xs sm:text-sm md:text-base px-2">
      ...
      <button
        ...
        className="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce z-20 cursor-pointer hover:scale-110 transition-all duration-300 p-2 rounded-full hover:bg-primary-400/20"
